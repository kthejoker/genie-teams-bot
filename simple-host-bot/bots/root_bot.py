...
class RootBot(ActivityHandler):
    ...
    async def on_message_activity(self, turn_context: TurnContext):
        if "genie" in turn_context.activity.text:
            # Begin forwarding Activities to the skill
            await turn_context.send_activity(
                MessageFactory.text("Got it, connecting you to Databricks Genie...")
            )
            ...
            await turn_context.send_activity(
                MessageFactory.text(
                    "Your wish is my command! Say \"genie\" and your question I'll patch you through"
                )
            )
    ...
    async def on_end_of_conversation_activity(self, turn_context: TurnContext):
        ...
        await turn_context.send_activity(
            MessageFactory.text(
                'Welcome back home! Say "genie" and I\'ll patch you through'
            )
        )
